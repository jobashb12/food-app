...
import "./HotTitleCard.css";

const HotTitleCard = ({ title, setTitle, name }) => {
    return (
        <motion.div
            whileTap={{ scale: 0.7 }}
            className={`hot-title-card ${title === name ? "hot-red" : ""}`}
        ...
        >
            ...
            <p className="hot-title-para">{name}</p>
        </motion.div>
    );
};

export default HotTitleCard;
